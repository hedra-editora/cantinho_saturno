...
\vspace*{1.8cm}
\addcontentsline{toc}{chapter}{A casa}
...
\vspace*{1.8cm}
\addcontentsline{toc}{chapter}{O canto}
...
\vspace*{1.8cm}
\addcontentsline{toc}{chapter}{A partida}
...
\vspace*{1.8cm}
\addcontentsline{toc}{chapter}{O livro}
...
\addcontentsline{toc}{chapter}{As asas de Saturno}
...
--- Sim, clichê, adiante\ldots{} um Golem! Criado a partir do barro\ldots{}
...
\vspace*{1.8cm}
\addcontentsline{toc}{chapter}{Margarida}
...
ir para o banho. Pôs um \versal{CD} do Nick Cave a tocar.
...
\vspace*{1.8cm}
\noindent{}\textbf{A voz}
\addcontentsline{toc}{chapter}{A voz}
...
Florimundo viu"-a avançar na sua direção e tremia. As pernas compridas,
...
\vspace*{1.8cm}
\addcontentsline{toc}{chapter}{Férias de Natal}
...
lado, empilhavam"-se livros e \versal{CD}s. Comprava tudo o que saía. O quarto
...
--- Como vês, para não pensares que exagero\ldots{} pensei que tinha encontrado
...
\addcontentsline{toc}{chapter}{Porque o tempo}
...
A seu lado, estava um \versal{CD} de Mahler, \emph{A Canção da Terra, }que ele
...
--- Por que falas assim? Encantador? Foste tu que o mataste?
...
\addcontentsline{toc}{chapter}{Tempus fugit}
